---
title: "MERS, SARS and SARS-CoV-2"
...
# lets prototype this by main(x[[2]])
...
#rename the folder
unlink("gmt_SARS_MERS", recursive = TRUE)
file.rename("gmt","gmt_SARS_MERS")

# some things are better done with bash :)
system("cat gmt_SARS_MERS/*gmt > SARS_MERS.gmt")
